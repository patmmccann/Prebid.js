...
export const spec = {
  ...
  onTimeout: function(timeoutData) {
    ...
    timeoutData.forEach(td => {
      ...
      scheduleBackgroundTask(() => triggerPixel(TRACKING_END_POINT + '/v1/hbTimeout?adp=prebidjs&data=' + encodedBuf));
    })
  },
  onBidWon: function (bidWon) {
    ...
    scheduleBackgroundTask(() => triggerPixel(TRACKING_END_POINT + '/v1/hbBidWon?adp=prebidjs&data=' + encodedBuf));
  }
};
